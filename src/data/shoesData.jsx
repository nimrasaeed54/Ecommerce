...
const shoesData = [
  { 
    ...
    badges: ["new"],
    description: "A classic Nike sneaker with premium cushioning and superior comfort for all-day wear."
  },
  { 
    id: 2, 
    ...
    badges: ["hot"],
    description: "Experience energy return like never before with Adidas Ultraboost, designed for ultimate performance."
  },
  { 
    id: 3, 
    name: "Puma RS-X", 
