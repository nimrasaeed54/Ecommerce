...
export default function CartPage() {
  ...
  return (
    <motion.div
      ...
      className="max-w-screen-full mx-auto p-6 h-screen bg-white rounded-3xl "
    >
      <motion.h1
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
          ...
          {cart.length > 0 ? (
            <div className="bg-gray-100 rounded-lg overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full text-[#333]">
                      ...
                      <tr key={item.id} className="border-b">
                        ...
                        <td className="p-4 text-center">
                          <div className="flex items-center justify-center gap-3">
                            <button className="bg-gray-400 text-white px-3 py-1 rounded-lg" onClick={() => decreaseQuantity(item.id)}>-</button>
                            <span className="text-lg font-semibold">{item.quantity}</span>
                            <button className="bg-gray-400 text-white px-3 py-1 rounded-lg" onClick={() => increaseQuantity(item.id)}>+</button>
                          </div>
                        </td>
